...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="nav-link" href="#">Logout</a>
                </li>
                @endauth
    ...
    <script>
        // window.Echo.private("tasks.{{ auth()->id() }}")
        //     .listen("TaskUpdated", (e) => {
        //         alert(`Task Updated: ${e.task.name}`);
        //     });

        Pusher.logToConsole = true;
        var pusher = new Pusher('b996546f2a0634ace636', {
            cluster: 'mt1'
        });
    </script>
